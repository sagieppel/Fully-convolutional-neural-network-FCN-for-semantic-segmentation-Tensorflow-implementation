...
##-----------------------Build Net Fully connvolutional layers------------------------------------------------------------------------------------
        ...
        self.relu_dropout6 = tf.nn.dropout(self.relu6,keep_prob=keep_prob, seed=0)  # Apply dropout for traning need to be added only for training
        ...
        self.relu_dropout7 = tf.nn.dropout(self.relu7, keep_prob=keep_prob, seed=0)  # Another dropout need to be used only for training
